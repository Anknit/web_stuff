...
$USE_PROXY = false;
$version="93";
$returnURL = $_SESSION['HTTP_ROOT'].'User/User%20Interface/confirmTransaction.php';
$cancelURL = $_SESSION['HTTP_ROOT'].'User/User%20Interface/UserPage.php';
