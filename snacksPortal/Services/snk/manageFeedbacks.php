...
?>
    <html>
        ...
        <body data-ng-app="snacksFeedback">
            ...
            <div class="container">
                <div class="col-md-12" data-ng-controller="feedbackManageController">
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                <caption>Feedbacks list</caption>
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Feedback</th>
                                ...
                                <tbody>
                                    <tr data-ng-repeat="feedback in feedbackList">
                                        <td>{{feedback.feedbackid}}</td>
                                        <td>{{feedback.feedbacktext}}</td>
                                        <td>{{feedback.feedbackuser}}</td>
                                        <td>{{getStatusText(feedback.feedbackstatus)}}</td>
                                        <td>{{feedback.createdon + ' UTC'}}</td>
                                        <td></td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <footer>
                ...
                <script type="text/javascript" src="./js/feedbackmodule.js"></script>
                <script type="text/javascript" src="./controller/feedback-manage-controller.js"></script>
            </footer>
        </body>
    </html>
<?php
